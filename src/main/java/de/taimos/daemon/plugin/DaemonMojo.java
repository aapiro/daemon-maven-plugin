...
public class DaemonMojo extends AbstractJarHeaderMojo {
	...
	protected String getCommand() {
		...
		return String.format("exec java -cp '%s.jar:lib/*' -Xmx%s -XX:ExitOnOutOfMemory -DstartupMode=%s -Djava.net.preferIPv4Stack=true %s %s \"$@\"", this.jarFile, this.maxMem, this.startupMode, opts, this.mainClass);
	}
